...
const ImportIDModal: React.FC = () => {
  ...
  const [detectedType, setDetectedType] = useState<BackupType>(
    BackupType.Unknown,
  );
    ...
    async (detectionResult: BackupDetectionResult) => {
      try {
        ...
        const mockEvent = {
          target: {
            files: [
              new File([JSON.stringify(detectionResult.data)], 'backup.json'),
            ],
          },
        ...
        {identity ? (
          ...
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-300 mb-4">
              This backup file is encrypted. Please enter your password to
              decrypt it.
            </p>
