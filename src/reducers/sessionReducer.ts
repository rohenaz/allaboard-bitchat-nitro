...
export const login = createAsyncThunk(
	'session/login',
	async ({ wallet, authToken, idKey }: LoginPayload, { dispatch, rejectWithValue }) => {
		try {
			if (idKey) {
...
export const { connectSocket, loginGuest, logout, setBapId, setError, setSigmaUser, setYoursUser } =
