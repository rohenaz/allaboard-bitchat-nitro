...
export const useActiveChannel = () => {
	...
	return (!loading && activeChannelId && channelsById[activeChannelId]) || false;
};
...
export const useActiveUserOld = () => {
	...
	return (!activeChannelId && !loading && activeUserId && usersById[activeUserId]) || false;
};
...
export const usePopover = () => {
	...
	return [user, anchorEl, showPopover, setShowPopover, handleClick, handleClickAway] as const;
};
