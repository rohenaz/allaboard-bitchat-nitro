...
const YoursContext = React.createContext<YoursContextType | undefined>(undefined);
...
const getUtxos = async (fromAddress: string, _pullFresh: boolean): Promise<Utxo[]> => {
	try {
...
const AutoYoursProvider: React.FC<AutoYoursProviderProps> = (props) => {
	...
	const [pandaProfile, setPandaProfile] = useState<ExtendedProfile | null>(null);
	...
	}, [isConnected, isReady, connected, connect, props, getSocialProfile, getAddresses, dispatch]);
	...
	}, [connected, getSocialProfile, getAddresses, utxos, getBalance, isReady, dispatch]);
