...
export const BapProvider: FC<{ children: ReactNode }> = ({ children }) => {
	...
	const [bapProfileStatus, _setBapProfileStatus] = useState<FetchStatus>(FetchStatus.Loading);
	const [loadIdentityStatus, setLoadIdentityStatus] = useState<FetchStatus>(FetchStatus.Idle);
	...
	}, [identity, hcDecrypt, decryptStatus, decIdentity, authToken, dispatch, isConnected]);
