...
export const SignupPage = React.lazy(() => import('../components/authForm/SignupPage'));
...
export const Dashboard = React.lazy(() =>
	import('../components/dashboard/ProperDiscordLayout').then((module) => ({
		default: module.ProperDiscordLayout,
	})),
);
...
// Lists
export const ChannelList = React.lazy(() => import('../components/dashboard/ChannelList'));

export const ServerList = React.lazy(() => import('../components/dashboard/ServerList'));
